...
\begin{center}19 abril, 2023\end{center}
...
Finally, we obtained a phenotypic data set containing body size
...
(Collyer and Adams 2018, 2022) and \texttt{geomorph} 4.0.5 (Baken et al.
2021a) for statistical analyses and the \texttt{tidyverse} version 1.3.0
...
they serve to channel phenotypic responses to selection, but do so in
...
display differing combinations of body size with body form. The
