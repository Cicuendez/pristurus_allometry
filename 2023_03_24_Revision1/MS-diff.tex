...
%DIF ADD PristurusMS-R1.tex      Wed Apr 12 16:16:21 2023
...
\begin{center}\DIFdelbegin \DIFdel{11 }\DIFdelend \DIFaddbegin \DIFadd{12 }\DIFaddend April, 2023\end{center}
...
\DIFdelbegin \DIFdel{Prior }\DIFdelend \DIFaddbegin \textbf{\DIFadd{HECTOR: please add: Why interesting from a macroevolutionary
perspective: 1) continent vs island, 2) its biogeographic location is
very relevant, between two continents that have their own faunas, 3) and
in a desertic region, which are traditionally neglected from a
biodiversity point of view. }} \DIFadd{Furthermore, prior }\DIFaddend work on this system
(Tejero-Cicuéndez et al. 2021a) \DIFaddbegin \DIFadd{has }\DIFaddend revealed that the colonization of
...
and small body sizes (Tejero-Cicuéndez et al. 2021a). What remains
unexplored, however, is how the evolution of body \DIFdelbegin \DIFdel{shape }\DIFdelend \DIFaddbegin \DIFadd{form }\DIFaddend is related to
differences in body size and whether habitat specialization has an
impact in this shape-size relationship. \hfill\break
...
large individuals in taxa utilizing other habitat types. \DIFdelbegin \DIFdel{Multivariate
visualizations of these multivariate }\DIFdelend \DIFaddbegin \DIFadd{Visualizations
of the }\DIFaddend allometric trends (Figure 2) confirmed these statistical
...
\leavevmode\vadjust pre{\DIFaddbegin \hypertarget{ref-Klingenberg2016}{}}%DIF > 
...
%DIF < 
\DIFdel{Rohlf, F. J., and M. Corti. 2000.
...
\DIFdelend \hypertarget{ref-SamuelsHopkins2017}{}}%
