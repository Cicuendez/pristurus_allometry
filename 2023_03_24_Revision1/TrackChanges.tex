...
%DIF ADD PristurusMS-R1_2.tex    Mon Apr 17 15:39:38 2023
...
\begin{center}\DIFdelbegin \DIFdel{11 }\DIFdelend \DIFaddbegin \DIFadd{17 }\DIFaddend April, 2023\end{center}
...
\DIFdelbegin \DIFdel{However, while }\DIFdelend \DIFaddbegin \DIFadd{While }\DIFaddend the patterns of morphological differences in distinct ecological
contexts have been well documented, less-well understood is how
\DIFdelbegin \DIFdel{this }\DIFdelend \DIFaddbegin \DIFadd{ecomorphological }\DIFaddend differentiation has been influenced by trait
covariation associated with body size differences (i.e., allometry). \DIFdelbegin \DIFdel{Evaluating
allometric trends across hierarchical levels }\DIFdelend \DIFaddbegin \DIFadd{The
...
sizes, as described by evolutionary allometry }\DIFaddend (\DIFdelbegin \DIFdel{e.g., comparing allometryat the individual level, or static allometry, and among species , or
evolutionary allometry ) may aid in our understanding of how adaptive
morphological change occurs at macroevolutionary scales (}\DIFdelend \DIFaddbegin \DIFadd{see Cock 1966;
}\DIFaddend Klingenberg and Zimmermann 1992). \DIFdelbegin \DIFdel{It has long been recognized that the
interrelationships among traits can exert a strong influence on how
phenotypic evolution proceeds, as }\DIFdelend \DIFaddbegin \DIFadd{Indeed, across vertebrates, numerous
...
\DIFadd{However, allometry can also act as a restraining force on evolution by
limiting the breadth of phenotypes that can be realized (Bright et al.
2019). This occurs because }\DIFaddend trait correlations influence the degree to
...
all linear traits covary strongly with overall body size\DIFdelbegin \DIFdel{(Jolicoeur
1963; Bookstein 2022)}\DIFdelend , allometric
trends could be considered the quintessential expression of phenotypic
integration \DIFaddbegin \DIFadd{(Zelditch and Swiderski 2022; Bookstein 2022)}\DIFaddend . Thus, \DIFdelbegin \DIFdel{identifying
whether allometric patterns differ across habitats, and how such
patterns }\DIFdelend \DIFaddbegin \DIFadd{when
evaluating ecophenotypic differences among taxa, it is important to
consider how allometric trends }\DIFaddend of trait covariation \DIFdelbegin \DIFdel{affect ecomorphological trends among
species utilizing those habitats, remains an important question worthy
of investigation. }\DIFdelend \DIFaddbegin \DIFadd{influence such
patterns (e.g., Esquerré et al. 2017; Patterson et al. 2022; Chatterji
et al. 2022). }\DIFaddend \hfill\break
...
}\emph{\DIFadd{Pristurus}} \DIFadd{and other Afro-Arabian taxa is also important
...
et al. 2012). Furthermore, prior }\DIFaddend work on this system (Tejero-Cicuéndez
et al. 2021a) \DIFaddbegin \DIFadd{has }\DIFaddend revealed that the colonization of ground habitats has
...
how the evolution of body \DIFdelbegin \DIFdel{shape }\DIFdelend \DIFaddbegin \DIFadd{form }\DIFaddend is related to differences in body size
...
allometry to be disentangled}\DIFaddend . From both the species-level \DIFdelbegin \DIFdel{(phylogenetic) }\DIFdelend and the
...
al. 2015). \DIFdelbegin \DIFdel{We then compared the }\DIFdelend \DIFaddbegin \DIFadd{In this analysis, no variation was attributable to the
...
}\DIFaddend multivariate allometric vectors for each habitat group to one another,
...
\DIFdelbegin \DIFdel{at
these hierarchical }\DIFdelend \DIFaddbegin \DIFadd{across these }\DIFaddend levels. Here, vectors of regression coefficients
...
First, our analyses revealed that patterns of \DIFdelbegin \DIFdel{body shape allometry }\DIFdelend \DIFaddbegin \DIFadd{allometry in body form }\DIFaddend and
...
found to display disproportionately large heads\DIFdelbegin \DIFdel{and long limbs}\DIFdelend . \hfill\break
...
\DIFaddbegin \DIFadd{Similar patterns have been observed in other taxa, where differences in
...
et al. 2022). }\DIFaddend More broadly, these findings are consistent with prior
...
\leavevmode\vadjust \DIFadd{pre}{\hypertarget{ref-Arnold1980}{}}%DIF > 
\DIFadd{Arnold, E. N. 1980. The reptiles and amphibians of }{\DIFadd{D}}\DIFadd{hofar, }{\DIFadd{S}}\DIFadd{outern
}{\DIFadd{A}}\DIFadd{rabia. Journal of Oman Studies Special Report:273--332.
}
...
\leavevmode\vadjust pre{\DIFaddbegin \hypertarget{ref-Bardua2021}{}}%DIF > 
\DIFadd{Bardua, C., A.-C. Fabre, J. Clavel, M. Bon, K. Das, E. L. Stanley, D. C.
Blackburn, and A. Goswami. 2021.
}\href{https://doi.org/10.1038/s41467-021-22792-y}{\DIFadd{Size, microhabitat,
and loss of larval feeding drive cranial diversification in frogs}}\DIFadd{.
Nature Communications 12. Springer Science; Business Media }{\DIFadd{LLC}}\DIFadd{.
}

\leavevmode\vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Bergmann1847}{}}%
...
\leavevmode\vadjust pre{\DIFaddbegin \hypertarget{ref-Bright2016}{}}%DIF > 
\DIFadd{Bright, J. A., J. Marugán-Lobón, S. N. Cobb, and E. J. Rayfield. 2016.
}\href{https://doi.org/10.1073/pnas.1602683113}{\DIFadd{The shapes of bird beaks
are highly controlled by nondietary factors}}\DIFadd{. Proceedings of the
National Academy of Sciences 113:5352--5357.
}

\leavevmode\vadjust \DIFadd{pre}{\hypertarget{ref-Bright2019}{}}%DIF > 
\DIFadd{Bright, J. A., J. Marugán-Lobón, E. J. Rayfield, and S. N. Cobb. 2019.
}\href{https://doi.org/10.1186/s12862-019-1432-1}{\DIFadd{The multifactorial
nature of beak and skull shape evolution in parrots and cockatoos
(psittaciformes)}}\DIFadd{. }{\DIFadd{BMC}} \DIFadd{Evolutionary Biology 19. Springer Science;
Business Media }{\DIFadd{LLC}}\DIFadd{.
}

\leavevmode\vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Brombacher2017}{}}%
...
\leavevmode\vadjust pre{\DIFaddbegin \hypertarget{ref-Cardini2015}{}}%DIF > 
\DIFadd{Cardini, A., D. Polly, R. Dawson, and N. Milne. 2015.
}\href{https://doi.org/10.1007/s11692-015-9308-9}{\DIFadd{Why the long face?
Kangaroos and wallabies follow the same }{\DIFadd{``rule''}} \DIFadd{of cranial
evolutionary allometry (}{\DIFadd{CREA}}\DIFadd{) as placentals}}\DIFadd{. Evolutionary Biology
42:169--176.
}

\leavevmode\vadjust \DIFadd{pre}{\hypertarget{ref-Cardini2013}{}}%DIF > 
\DIFadd{Cardini, A., and P. D. Polly. 2013.
}\href{https://doi.org/10.1038/ncomms3458}{\DIFadd{Larger mammals have longer
faces because of size-related constraints on skull form}}\DIFadd{. Nature
Communications 4.
}

\leavevmode\vadjust \DIFadd{pre}{\hypertarget{ref-Chatterji2022}{}}%DIF > 
\DIFadd{Chatterji, R. M., C. A. Hipsley, E. Sherratt, M. N. Hutchinson, and M.
E. H. Jones. 2022.
}\href{https://doi.org/10.1007/s10682-022-10162-z}{\DIFadd{Ontogenetic allometry
underlies trophic diversity in sea turtles (chelonioidea)}}\DIFadd{. Evolutionary
Ecology 36:511--540.
}

\leavevmode\vadjust \DIFadd{pre}{\hypertarget{ref-Cock1966}{}}%DIF > 
\DIFadd{Cock, A. G. 1966. }\href{https://doi.org/10.1086/404940}{\DIFadd{Genetical
aspects of metrical growth and form in animals}}\DIFadd{. The Quarterly Review of
Biology 41:131--190.
}

\leavevmode\vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-COLLAR2010}{}}%
...
\leavevmode\vadjust \DIFadd{pre}{\hypertarget{ref-Esquerre2017}{}}%DIF > 
\DIFadd{Esquerré, D., E. Sherratt, and J. S. Keogh. 2017.
}\href{https://doi.org/10.1111/evo.13382}{\DIFadd{Evolution of extreme
ontogenetic allometric diversity and heterochrony in pythons, a clade of
giant and dwarf snakes}}\DIFadd{. Evolution 71:2829--2844.
}

\leavevmode\vadjust \DIFadd{pre}{\hypertarget{ref-Felice2021}{}}%DIF > 
\DIFadd{Felice, R. N., D. Pol, and A. Goswami. 2021.
}\href{https://doi.org/10.1098/rspb.2021.0919}{\DIFadd{Complex macroevolutionary
dynamics underly the evolution of the crocodyliform skull}}\DIFadd{. Proceedings
...
\leavevmode\vadjust pre{\DIFaddbegin \hypertarget{ref-GOULD1966}{}}%DIF > 
\DIFadd{Gould, S. J. 1966.
}\href{https://doi.org/10.1111/j.1469-185x.1966.tb01624.x}{\DIFadd{Allometry and
size in ontogeny and phylogeny}}\DIFadd{. Biological Reviews 41:587--638.
}

\leavevmode\vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Grant2006}{}}%
...
\leavevmode\vadjust \DIFadd{pre}{\hypertarget{ref-Huxley1932}{}}%DIF > 
\DIFadd{Huxley, J. S. 1932. The problems of relative growth. Johns Hopkins
University Pres.
}
...
\leavevmode\vadjust \DIFadd{pre}{\hypertarget{ref-Klingenbert1996}{}}%DIF > 
\DIFadd{Klingenberg, C. P. 1996. Advances in morphometrics. Pp. 23--49 }\emph{\DIFadd{in}}
\DIFadd{L. F. Marcus, M. Corti, A. Loy, and G. J. P. N. D. E. Slice, eds. Plenum
Press.
}
...
\leavevmode\vadjust pre{\DIFaddbegin \hypertarget{ref-Patterson2022}{}}%DIF > 
\DIFadd{Patterson, M., A. K. Wolfe, P. A. Fleming, P. W. Bateman, M. L. Martin,
E. Sherratt, and N. M. Warburton. 2022.
}\href{https://doi.org/10.1007/s10682-022-10164-x}{\DIFadd{Ontogenetic shift in
diet of a large elapid snake is facilitated by allometric change in
skull morphology}}\DIFadd{. Evolutionary Ecology 36:489--509.
}

\leavevmode\vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Pavlicev2009}{}}%
...
\leavevmode\vadjust pre{\DIFaddbegin \hypertarget{ref-Piras2010}{}}%DIF > 
\DIFadd{Piras, P., P. Colangelo, D. C. Adams, A. Buscalioni, J. Cubo, T.
Kotsakis, C. Meloro, and P. Raia. 2010.
}\href{https://doi.org/10.1111/j.1525-142x.2010.00442.x}{\DIFadd{The
...
relationships}}\DIFadd{. Evolution and Development 12:568--579.
}

\leavevmode\vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Price2015}{}}%
...
\leavevmode\vadjust pre{\DIFaddbegin \hypertarget{ref-PYRON2009}{}}%DIF > 
\DIFadd{Pyron, R. A., and F. T. Burbrink. 2009.
}\href{https://doi.org/10.1111/j.1420-9101.2009.01820.x}{\DIFadd{Body size as a
...
colubridae)}}\DIFadd{. Journal of Evolutionary Biology 22:2057--2067. Wiley.
}

\leavevmode\vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-RCT}{}}%
...
\leavevmode\vadjust pre{\DIFaddbegin \hypertarget{ref-Sherratt2014}{}}%DIF > 
\DIFadd{Sherratt, E., D. J. Gower, C. P. Klingenberg, and M. Wilkinson. 2014.
}\href{https://doi.org/10.1007/s11692-014-9287-2}{\DIFadd{Evolution of cranial
shape in caecilians (amphibia: gymnophiona)}}\DIFadd{. Evolutionary Biology
41:528--545.
}

\leavevmode\vadjust \DIFadd{pre}{\hypertarget{ref-Sidlauskas2008}{}}%DIF > 
...
\DIFaddbegin \leavevmode\vadjust \DIFadd{pre}{\hypertarget{ref-Zelditch2022}{}}%DIF > 
\DIFadd{Zelditch, M. L., and D. L. Swiderski. 2022.
}\href{https://doi.org/10.1007/s11692-022-09581-1}{\DIFadd{The predictable
complexity of evolutionary allometry}}\DIFadd{. Evolutionary Biology 50:56--77.
}
