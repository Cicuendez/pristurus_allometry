...
%DIF ADD PristurusMS-R1_2.tex    Wed Apr 19 10:20:34 2023
...
\begin{center}\DIFdelbegin \DIFdel{11 }\DIFdelend \DIFaddbegin \DIFadd{19 }\DIFaddend April, 2023\end{center}
...
body of literature. \DIFaddbegin \DIFadd{Nonetheless, because the ecological shift to
...
\DIFaddbegin \DIFadd{However, considering the habitat-driven morphology perspective, the
...
the largest ground-dwelling }\emph{\DIFadd{Pristurus}} \DIFadd{species (}\emph{\DIFadd{P. carteri}}\DIFadd{,
}\emph{\DIFadd{P. ornitocephalus}}\DIFadd{, and }\emph{\DIFadd{P. collaris}}\DIFadd{) differ from the rest
...
use and morphological and allometric trends in }\emph{\DIFadd{Pristurus}}\DIFadd{.
}\hfill\break
