...
%DIF DEL PristurusMS-2-DCA.tex   Thu Oct  6 12:11:34 2022
%DIF ADD PristurusMS-3.tex       Thu Oct 13 10:40:03 2022
...
%DIFDELCMD < %%%
\DIFdelend When \DIFaddbegin \DIFadd{static }\DIFaddend allometric patterns were mapped on the phylogeny, traitgrams
...
\DIFadd{The relationship between certain phenotypic traits and the organisms'
...
in the geckos of the genus }\emph{\DIFadd{Pristurus}}\DIFadd{. In particular, we
...
\DIFadd{Patterns of multivariate allometry in body form calculated from
...
\textbf{\DIFadd{??We also explored patterns of static allometry to compare them
...
\DIFadd{When we compared multivariate allometric slopes of species occupying
...
}\emph{\DIFadd{Pristurus}} \DIFadd{present proportionally larger heads and longer limbs
relative to other large species, while small species in the ground have
proportionally smaller heads and shorter limbs (}\textbf{\DIFadd{Figure residuals
traitgrams}}\DIFadd{). This is consistent with previous results on the
morphological evolution of }\emph{\DIFadd{Pristurus}} \DIFadd{(Tejero-Cicuéndez et
...
ground-dwelling species (including the largest of the genus, }\emph{\DIFadd{P.
carteri}}\DIFadd{), which has already been suggested to be the main driver of the
...
}\emph{\DIFadd{Pristurus}} \DIFadd{geckos adapted to hard grounds (e.g., }\textbf{\DIFadd{some
definition of hard ground vs.~soft grounds??}}\DIFadd{), illustrating the
...
\DIFadd{Similarly, when analyzing patterns of morphological integration, we
...
are allowed to vary (}\textbf{\DIFadd{REF}}\DIFadd{). Weaker integration levels (i.e.,
...
(}\textbf{\DIFadd{REF}}\DIFadd{). However, integration might also be interpreted as a
...
this primary axis. The fact that ground species in }\emph{\DIFadd{Pristurus}} \DIFadd{have
...
\DIFadd{Another insightful result is the low correlation between head and limbs
...
}\emph{\DIFadd{Pristurus}} \DIFadd{and other lizards, including for instance finer
...
\DIFaddend \item
  ...
  (Schluter ref again)
\DIFaddbegin \item
  \DIFadd{On the relationship between static and evolutionary allometry
}\DIFaddend \end{itemize}

\DIFaddbegin \DIFadd{There is no general consensus about the relationship between the three
...
evolutionary allometry are very similar in }\emph{\DIFadd{Pristurus}} \DIFadd{geckos,
...
Journal of the American Statistical Association 65:930--945\DIFaddbegin \DIFadd{.
}

\leavevmode\vadjust \DIFadd{pre}{\hypertarget{ref-Navalon2020}{}}%DIF > 
\DIFadd{Navalón, G., J. Marugán-Lobón, J. A. Bright, C. R. Cooney, and E. J.
...
Nature Ecology \& Evolution 4:270--278. Nature Publishing Group}\DIFaddend .
