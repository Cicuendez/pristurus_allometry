...
%DIF DEL PristurusMS-2.tex       Wed Oct  5 17:15:30 2022
%DIF ADD PristurusMS-2-DCA.tex   Thu Oct  6 12:11:34 2022
...
\hypersetup{
%DIF 101c101
%DIF <   pdftitle={The role of habitat and evolutionary allometry in the morphological differentiation of Pristurus geckos},
%DIF -------
...
morphological differentiation of \emph{Pristurus} geckos \DIFaddbegin \DIFadd{(OR: Evolution
along allometric lines of least resistance: Morphological
differentiation in \emph{Pristurus} geckos)}\DIFaddend }
\author{}
\date{\vspace{-2.5em}}
...
\begin{center}\DIFdelbegin \DIFdel{05 }\DIFdelend \DIFaddbegin \DIFadd{06 }\DIFaddend October, 2022\end{center}
...
species utilizing those habitats, remains an important \DIFdelbegin \DIFdel{understudied
}\DIFdelend question worthy
...
overall phenotypic \DIFaddbegin \DIFadd{integration, }\DIFaddend diversification in morphospace, and
\DIFdelbegin \DIFdel{in relation to
habitat utilization }\DIFdelend \DIFaddbegin \DIFadd{habitat utilization among taxa}\DIFaddend . Overall our results demonstrate that the
...
cladelevel}\DIFdelend \DIFaddbegin \DIFadd{in this clade}\DIFaddend .
...
We conducted a series of analyses to interrogate allometric trends\DIFaddbegin \DIFadd{,
patterns of integration, }\DIFaddend and macroevolutionary changes in allometry,
...
\DIFaddbegin \DIFadd{Next, because allometry describes the extent to which traits covary with
...
\DIFaddend Finally, to relate within-species allometric trends with patterns of
...
relationships and habitat affiliations, were observed. \DIFaddbegin \DIFadd{A similar
...
Information). }\DIFaddend All analyses were conducted in R 4.2.1 (R Core Team 2022),
using \texttt{RRPP} version 1.3.1 (Collyer and Adams 2018; Collyer and
Adams 2022) \DIFaddbegin \DIFadd{and }\texttt{\DIFadd{geomorph}} \DIFadd{4.0.4 (Baken et al. 2021)}\DIFaddend , and scripts
...
\DIFaddbegin \DIFadd{Examination of patterns of trait covariation revealed strong levels of
...
significantly greater in ground-dwelling }\emph{\DIFadd{Pristurus}} \DIFadd{than either
those utilizing rock (\(Z_{Groung-Rock}=6.59\); \(P << 0.001\)) or tree
habitats (\(Z_{Groung-Tree}=11.17\); \(P << 0.001\)). }\emph{\DIFadd{Pristurus}}
\DIFadd{utilizing tree habitats displayed the lowest levels of integration,
...
\DIFaddend When allometric patterns were mapped on the phylogeny, traitgrams
...
\DIFdelbegin \DIFdel{When }\DIFdelend \DIFaddbegin \DIFadd{Finally, when }\DIFaddend body shape differentiation in \emph{Pristurus} was viewed
...
displayed similar body shapes as well. \DIFdelbegin \DIFdel{Finally, integrating }\DIFdelend \DIFaddbegin \DIFadd{Thus, synthesizing }\DIFaddend the patterns
...
habitat use, \DIFaddbegin \DIFadd{morphological integration, }\DIFaddend and multivariate allometry;
...
\item
  ...
  \end{itemize}
\item
  result 1: \DIFdelbegin \DIFdel{implication
}\DIFdelend \DIFaddbegin \DIFadd{allometry; overall trend among species nearly identical to
  that among individuals. Thus, patterns of static and evolutionary
  allometry are consistent in }\emph{\DIFadd{Pristurus}}\DIFadd{\ldots{} Something else
  about this
}\DIFaddend \item
  result 2: \DIFdelbegin \DIFdel{implication
}\DIFdelend \DIFaddbegin \DIFadd{Allometry differs among habitat groups: `steeper' allometry
  in Ground-dwelling (implication: proportionately larger heads and
  longer limbs in species at larger body sizes).
}\DIFaddend \item
  result 3: \DIFdelbegin \DIFdel{implication
}\DIFdelend \DIFaddbegin \DIFadd{Morphological integration differs among habitat groups.
  ...
  \tightlist
  \item
    \DIFaddbegin \DIFadd{Additionally, rank-order of magnitude of integration across habitat
    ...
    }\emph{\DIFadd{Pristurus}} \DIFadd{is the result of allometric trends\ldots. And the
    ...
    ground-dwelling }\emph{\DIFadd{Pristurus}} \DIFadd{are still relatively constrained in
    patterns of trait covariation as compared with the other two
    groups.}\\
  \item
    \DIFadd{This notion was further supported when viewing the phylomorphospace
...
\item
  \DIFadd{result 4: }\DIFaddend morphospace: Thus there was a reciprocal relationship
  between body shape and body size across ground-dwelling and
  rock-dwelling species. \DIFdelbegin %DIFDELCMD < \end{itemize}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \DIFadd{SOMEHOW TIE THIS TO integration (DCA pondering
  this one)
}\DIFaddend \item
...
\DIFaddbegin \item
  \DIFadd{In conclusion\ldots{} -Synthesizing these patterns together \ldots{}
  ...
  diversification among ground-dwelling }\emph{\DIFadd{Pristurus}} \DIFadd{follows tightly
  ...
  Goswami `fly in a tube' paper. Thus, }\emph{\DIFadd{Pristurus body forms appear
  to diversify along }}\DIFadd{allometric* lines of least resistance\ldots.
  (Schluter ref again)
}\DIFaddend \end{itemize}

\DIFdelbegin \DIFdel{closing paragraph
}%DIFDELCMD < 
...
\leavevmode\vadjust pre{\DIFaddbegin \hypertarget{ref-Baken2021}{}}%DIF > 
\DIFadd{Baken, E. K., M. L. Collyer, A. Kaliontzopoulou, and D. C. Adams. 2021.
...
\leavevmode\vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-BERNER2008}{}}%
...
\leavevmode\vadjust pre{\DIFaddbegin \hypertarget{ref-ConawayAdams2022}{}}%DIF > 
\DIFadd{Conaway, M. A., and D. C. Adams. 2022.
}\href{https://doi.org/10.1111/evo.14595}{\DIFadd{An effect size for comparing
the strength of morphological integration across studies}}\DIFadd{. Evolution
76:(In Press).
}

\leavevmode\vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-DrakeKlingenberg2008}{}}%
...
\leavevmode\vadjust pre{\DIFaddbegin \hypertarget{ref-Mosimann1970}{}}%DIF > 
\DIFadd{Mosimann, J. E. 1970. Size allometry: Size and shape variables with
...
\leavevmode\vadjust \DIFadd{pre}{\hypertarget{ref-Pavlicev2009}{}}%DIF > 
\DIFadd{Pavlicev, M., J. M. Cheverud, and G. P. Wagner. 2009.
}\href{https://doi.org/10.1007/s11692-008-9042-7}{\DIFadd{Measuring morphological
integration using eigenvalue variance}}\DIFadd{. Evolutionary Biology
36:157--170.
}
...
means are colored by habitat use: \DIFdelbegin \DIFdel{grou d }\DIFdelend \DIFaddbegin \DIFadd{ground }\DIFaddend (beige), rock (dark purple),
