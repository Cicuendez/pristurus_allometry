...
%DIF ADD PristurusMS-2-DCA.tex   Thu Oct 27 15:00:15 2022
...
\hypersetup{
  pdftitle={The role of habitat and evolutionary allometry in the morphological differentiation of Pristurus geckos (OR: Evolution along allometric lines of least resistance: Morphological differentiation in Pristurus geckos)},
  hidelinks,
...
(\(\rho = 0.42\)). }%DIFDELCMD < \hfill\break
%DIFDELCMD < 
...
\DIFaddbegin \DIFadd{When allometric patterns were mapped on the phylogeny, traitgrams
...
\DIFdelend \item
  ...
  that among individuals. \DIFdelbegin %DIFDELCMD < \end{itemize}
%DIFDELCMD < 
...
per-species means in Pristurus geckos. Specifically, the vectors of regression coefficients of the two analyses are virtually parallel
(\(\theta = 1.49^\circ\)), indicating that the evolutionary
  allometry is
...
%DIFDELCMD < \tightlist
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \DIFadd{Thus, patterns of static and evolutionary
...
\leavevmode\vadjust pre{\DIFdelbegin %DIFDELCMD < \hypertarget{ref-Navalon2020}{}}%%%
%DIF < 
...
\DIFdelend \hypertarget{ref-Pavlicev2009}{}}%
