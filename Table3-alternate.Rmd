...
## REDO AND SIMPLIFY THIS TABLE (keep old one for posterity: it was pretty cool!)
...
kbl(tb2, align = "cccc","latex", booktabs=TRUE,caption ="Pairwise comparisons of multivariate evolutionary allometry versus static allometry for each habitat group. Pairwise angular differences, their associated effect sizes ($Z_{\\theta_{12}}$), and significance levels are displayed. Significance levels evaluate whether the observed angle is smaller than expected (i.e., vector directions are similar).", escape = FALSE) %>%
    pack_rows("Angle", 1, 4) %>%
...
```{r, fig.align="center",  echo=FALSE, out.width="100%", fig.cap = "adsf"}
