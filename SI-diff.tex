...
%DIF DEL Pristurus-SuppInfo.tex     Wed Oct  5 09:32:58 2022
%DIF ADD Pristurus-SuppInfo-2.tex   Wed Oct  5 09:32:39 2022
...
\NormalTok{ind.coef }\OtherTok{\textless{}{-}} \FunctionTok{rbind}\NormalTok{(fit.coef[}\DecValTok{2}\NormalTok{,], fit.coef[}\DecValTok{2}\NormalTok{,]}\SpecialCharTok{+}\NormalTok{fit.coef[}\DecValTok{5}\NormalTok{,], fit.coef[}\DecValTok{2}\NormalTok{,]}\SpecialCharTok{+}\NormalTok{fit.coef[}\DecValTok{6}\NormalTok{,])}
...
\CommentTok{\# 4: phylomorphospace of size{-}standardized data (residuals)}
...
Here we see that \DIFdelbegin \DIFdel{XYZPDQ
}\DIFdelend \DIFaddbegin \DIFadd{there are differential allometric dynamics for some
...
ground species, }\emph{\DIFadd{Pristurus ornithocephalus}} \DIFadd{(the fourth largest
...
{\centering \includegraphics[width=1\linewidth]{Figs/phenograms_variables} 
