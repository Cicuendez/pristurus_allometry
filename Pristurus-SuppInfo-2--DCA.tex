...
\NormalTok{lindims.gp }\OtherTok{\textless{}{-}} \FunctionTok{lapply}\NormalTok{( }\FunctionTok{split}\NormalTok{( shape[,}\DecValTok{1}\SpecialCharTok{:}\FunctionTok{ncol}\NormalTok{(shape)], rdf}\SpecialCharTok{$}\NormalTok{habitat), matrix, }\AttributeTok{ncol=}\FunctionTok{ncol}\NormalTok{(shape))}
