...
\NormalTok{mn.sz }\OtherTok{\textless{}{-}} \FunctionTok{tapply}\NormalTok{(rdf}\SpecialCharTok{$}\NormalTok{svl,rdf}\SpecialCharTok{$}\NormalTok{habitat,mean)}
\NormalTok{mn.shape }\OtherTok{\textless{}{-}} \FunctionTok{rowsum}\NormalTok{(rdf}\SpecialCharTok{$}\NormalTok{shape, rdf}\SpecialCharTok{$}\NormalTok{habitat)}\SpecialCharTok{/}\FunctionTok{as.vector}\NormalTok{(}\FunctionTok{table}\NormalTok{(rdf}\SpecialCharTok{$}\NormalTok{habitat))}
...
\NormalTok{X }\OtherTok{\textless{}{-}} \FunctionTok{model.matrix}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\NormalTok{rdf}\SpecialCharTok{$}\NormalTok{svl}\SpecialCharTok{+}\NormalTok{rdf}\SpecialCharTok{$}\NormalTok{habitat)}
...
\NormalTok{E.iso }\OtherTok{\textless{}{-}}\NormalTok{ rdf}\SpecialCharTok{$}\NormalTok{shape }\SpecialCharTok{{-}}\NormalTok{ preds }
...
\NormalTok{  slopes[[j]] }\OtherTok{\textless{}{-}} \FunctionTok{pairwise}\NormalTok{(}\FunctionTok{lm.rrpp}\NormalTok{((preds}\SpecialCharTok{+}\NormalTok{E.iso[perms[[j]],]) }\SpecialCharTok{\textasciitilde{}}\NormalTok{ rdf}\SpecialCharTok{$}\NormalTok{svl}\SpecialCharTok{*}\NormalTok{rdf}\SpecialCharTok{$}\NormalTok{habitat, }
          \AttributeTok{iter=}\DecValTok{0}\NormalTok{), }\AttributeTok{groups =}\NormalTok{ rdf}\SpecialCharTok{$}\NormalTok{habitat,}\AttributeTok{covariate =}\NormalTok{ rdf}\SpecialCharTok{$}\NormalTok{svl)}\SpecialCharTok{$}\NormalTok{slopes[[}\DecValTok{1}\NormalTok{]]}
\NormalTok{\}  }
...
\NormalTok{slp.ang.ev }\OtherTok{\textless{}{-}} \FunctionTok{lapply}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\DecValTok{1000}\NormalTok{, }\ControlFlowTok{function}\NormalTok{(j) }\FunctionTok{cos}\NormalTok{(RRPP}\SpecialCharTok{:::}\FunctionTok{vec.cor.matrix}\NormalTok{(}\FunctionTok{rbind}\NormalTok{(coef.evol,}
\NormalTok{              slopes[[j]])))}\SpecialCharTok{*}\DecValTok{180}\SpecialCharTok{/}\NormalTok{pi)}
...
\includegraphics{Pristurus-SuppInfo_files/figure-latex/unnamed-chunk-8-1.pdf}
