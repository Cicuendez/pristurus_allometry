...
%DIF DEL PristurusMS-5.tex          Mon Nov 14 14:42:14 2022
%DIF ADD PristurusMS-5-HTC-IM.tex   Tue Nov 22 11:11:40 2022
...
\begin{center}
\textbf{H{\'{e}}ctor Tejero-Cicu{\'{e}}ndez$^{1,*}$,  Iris Men{\'{e}}ndez\DIFdelbegin \DIFdel{$^{2,3}$}\DIFdelend \DIFaddbegin \DIFadd{$^{2}$}\DIFaddend , Adri{\'{a}}n Talavera\DIFaddbegin \DIFadd{$^{1}$}\DIFaddend , Gabriel Riaño\DIFaddbegin \DIFadd{$^{1}$}\DIFaddend , Bernat Burriel-Carranza$^{1}$, Marc Sim{\'{o}}-Riudalbas$^{1}$, Salvador Carranza$^{1}$, and Dean C. Adams\DIFdelbegin \DIFdel{$^{4}$}\DIFdelend \DIFaddbegin \DIFadd{$^{3}$}\DIFaddend }
\end{center}

\begin{center}\DIFdelbegin \DIFdel{14 }\DIFdelend \DIFaddbegin \DIFadd{22 }\DIFaddend November, 2022\end{center}
...
\(^{2}\)\DIFdelbegin \DIFdel{Departamento de Geodinámica, Estratigrafía y Paleontología, Facultad de Ciencias Geológicas, Universidad Complutense de Madrid,
C/José Antonio Novais 12, Madrid 28040, Spain
}\DIFdelend \DIFaddbegin \DIFadd{Museum für Naturkunde, Leibniz Institute for Evolution and
Biodiversity Science, Berlin, Germany
}\DIFaddend 

\(^{3}\)\DIFdelbegin \DIFdel{Departamento de Cambio Medioambiental, Instituto de Geociencias
(UCM, CSIC), C/Severo Ochoa 7, Madrid 28040, Spain
}%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{\(^{4}\)}\DIFdelend Department of Ecology, Evolution, and Organismal Biology, Iowa
...
ecophenotypic patterns are affected by allometric trends and \DIFdelbegin \DIFdel{levels of
trait
integration }\DIFdelend \DIFaddbegin \DIFadd{trait
integration levels }\DIFaddend is less well understood. Here we evaluate the role of
...
\emph{Pristurus} displaying the most divergent allometric trend \DIFaddbegin \DIFadd{and the
strongest integration}\DIFaddend . There was also strong concordance between static
...
(though less extreme than that of ground-dwelling taxa), whereas \DIFdelbegin \DIFdel{limb
scaling }\DIFdelend \DIFaddbegin \DIFadd{most
limb traits }\DIFaddend in tree-dwelling taxa \DIFdelbegin \DIFdel{was isometric }\DIFdelend \DIFaddbegin \DIFadd{showed negative allometry or nearly
isometry }\DIFaddend (Supplementary Material). Thus, these findings implied that
...
\CSLLeftMargin{11. }%
\DIFdelbegin %DIFDELCMD < \CSLRightInline{Schluter D, Grant PR. 1984 Determinants of morphological
%DIFDELCMD < patterns in communities of darwin{\textquotesingle}s finches. \emph{The
%DIFDELCMD < American Naturalist} \textbf{123}, 175--196.
%DIFDELCMD < (doi:\href{https://doi.org/10.1086/284196}{10.1086/284196})}
%DIFDELCMD < %%%
...
\CSLLeftMargin{13. }%
\DIFdelbegin %DIFDELCMD < \CSLRightInline{Reaney AM, Bouchenak-Khelladi Y, Tobias JA, Abzhanov A.
%DIFDELCMD < 2020 Ecological and morphological determinants of evolutionary
%DIFDELCMD < diversification in darwin{\textquotesingle}s finches and their
%DIFDELCMD < relatives. \emph{Ecology and Evolution} \textbf{10}, 14020--14032.
%DIFDELCMD < (doi:\href{https://doi.org/10.1002/ece3.6994}{10.1002/ece3.6994})}
%DIFDELCMD < %%%
...
\CSLLeftMargin{15. }%
\DIFdelbegin %DIFDELCMD < \CSLRightInline{Urban S, Gerwin J, Hulsey CD, Meyer A, Kratochwil CF.
%DIFDELCMD < 2022 The repeated evolution of stripe patterns is correlated with body
%DIFDELCMD < morphology in the adaptive radiations of east african cichlid fishes.
%DIFDELCMD < \emph{Ecology and Evolution} \textbf{12}, e8568.
%DIFDELCMD < (doi:\href{https://doi.org/10.1002/ece3.8568}{10.1002/ece3.8568})}
%DIFDELCMD < %%%
...
\CSLLeftMargin{27. }%
\DIFdelbegin %DIFDELCMD < \CSLRightInline{Navalón G, Marugán-Lobón J, Bright JA, Cooney CR,
%DIFDELCMD < Rayfield EJ. 2020 The consequences of craniofacial integration for the
%DIFDELCMD < adaptive radiations of darwin's finches and hawaiian honeycreepers.
%DIFDELCMD < \emph{Nature Ecology \& Evolution} \textbf{4}, 270--278.
%DIFDELCMD < (doi:\href{https://doi.org/10.1038/s41559-019-1092-y}{10.1038/s41559-019-1092-y})}
%DIFDELCMD < %%%
...
\CSLLeftMargin{28. }%
\DIFdelbegin %DIFDELCMD < \CSLRightInline{Jolicoeur P. 1963 The multivariate generalization of the
%DIFDELCMD < allometry equation. \emph{Biometrics} \textbf{19}, 497--499.}
%DIFDELCMD < %%%
...
\CSLLeftMargin{31. }%
\DIFdelbegin %DIFDELCMD < \CSLRightInline{Tejero-Cicuéndez H, Patton AH, Caetano DS, Šmíd J,
%DIFDELCMD < Harmon LJ, Carranza S. 2022 Reconstructing squamate biogeography in
%DIFDELCMD < afro-arabia reveals the influence of a complex and dynamic geologic
%DIFDELCMD < past. \emph{Systematic Biology} \textbf{71}, 261--272.}
%DIFDELCMD < %%%
...
\CSLLeftMargin{38. }%
\DIFdelbegin %DIFDELCMD < \CSLRightInline{Drake AG, Klingenberg CP. 2008 The pace of morphological
%DIFDELCMD < change: Historical transformation of skull shape in st bernard dogs.
%DIFDELCMD < \emph{Proceedings of the Royal Society B: Biological Sciences}
%DIFDELCMD < \textbf{275}, 71--76.
%DIFDELCMD < (doi:\href{https://doi.org/10.1098/rspb.2007.1169}{10.1098/rspb.2007.1169})}
%DIFDELCMD < %%%
...
\CSLLeftMargin{39. }%
\DIFdelbegin %DIFDELCMD < \CSLRightInline{Adams DC, Nistri A. 2010 Ontogenetic convergence and
%DIFDELCMD < evolution of foot morphology in european cave salamanders (family:
%DIFDELCMD < plethodontidae). \emph{BMC Evolutionary Biology} \textbf{10}, 1--10.
%DIFDELCMD < (doi:\href{https://doi.org/10.1186/1471-2148-10-216}{10.1186/1471-2148-10-216})}
%DIFDELCMD < %%%
...
\CSLLeftMargin{46. }%
\DIFdelbegin %DIFDELCMD < \CSLRightInline{Collyer ML, Adams DC. 2018 RRPP: An r package for
%DIFDELCMD < fitting linear models to high-dimensional data using residual
%DIFDELCMD < randomization. \emph{Methods in Ecology and Evolution} \textbf{9},
%DIFDELCMD < 1772--1779.
%DIFDELCMD < (doi:\href{https://doi.org/10.1111/2041-210X.13029}{10.1111/2041-210X.13029})}
%DIFDELCMD < %%%
...
\CSLLeftMargin{50. }%
\DIFdelbegin %DIFDELCMD < \CSLRightInline{Revell LJ. 2012 Phytools: An r package for phylogenetic
%DIFDELCMD < comparative biology (and other things). \emph{Methods in Ecology and
%DIFDELCMD < Evolution} \textbf{3}, 217--223.
%DIFDELCMD < (doi:\href{https://doi.org/10.1111/j.2041-210X.2011.00169.x}{10.1111/j.2041-210X.2011.00169.x})}
%DIFDELCMD < %%%
...
\CSLLeftMargin{51. }%
\DIFdelbegin %DIFDELCMD < \CSLRightInline{Marroig G, Cheverud JM. 2005 Size as a line or least
%DIFDELCMD < evolutionary resistance: Diet and adaptive morphological radiation in
%DIFDELCMD < new world monkeys. \emph{Evolution} \textbf{59}, 1128--1142.
%DIFDELCMD < (doi:\href{https://doi.org/10.1111/j.0014-3820.2005.tb01049.x}{10.1111/j.0014-3820.2005.tb01049.x})}
%DIFDELCMD < %%%
...
\CSLLeftMargin{62. }%
\DIFdelbegin %DIFDELCMD < \CSLRightInline{Tamar K, Mitsi P, SimÓ-Riudalbas M, Tejero-Cicuéndez H,
%DIFDELCMD < Al-Sariri T, Carranza S. 2019 Systematics, biogeography, and evolution
%DIFDELCMD < of \emph{pristurus minimus} (squamata, sphaerodactylidae) with the
%DIFDELCMD < discovery of the smallest arabian vertebrate. \emph{Systematics and
%DIFDELCMD < Biodiversity} \textbf{17}, 349--366.
%DIFDELCMD < (doi:\href{https://doi.org/10.1080/14772000.2019.1614694}{10.1080/14772000.2019.1614694})}
%DIFDELCMD < %%%
...
SC)\DIFaddbegin \DIFadd{. IM was funded by the Alexander von Humboldt Foundation through a
Humboldt Research Fellowship. }\DIFaddend DCA was funded in part by National Science
...
\caption{Patterns of static allometry for each species for head traits (upper panel) and limb traits (lower panel). Species are separated by their habitat groups and colored by the magnitude of their regression slope (\DIFdelbeginFL \DIFdelFL{red}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{purple}\DIFaddendFL : steeper slopes, \DIFdelbeginFL \DIFdelFL{blue}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{yellow}\DIFaddendFL : shallower slopes).}\label{fig:unnamed-chunk-7}
\end{figure}
