...
%DIF DEL PristurusMS.tex     Fri Sep 30 10:48:35 2022
%DIF ADD PristurusMS-2.tex   Wed Oct  5 09:29:03 2022
...
\begin{center}
\textbf{ORDER TBD:  H{\'{e}}ctor Tejero-Cicu{\'{e}}ndez$^{1,*}$,  Iris Men{\'{e}}ndez$^{2,3}$, \DIFaddbegin \DIFadd{Adri}{\DIFadd{\'{a}}} \DIFadd{Talavera, }\DIFaddend Marc Sim{\'{o}}\DIFdelbegin \DIFdel{Riudalbas}\DIFdelend \DIFaddbegin \DIFadd{-Riudalbas}\DIFaddend $^{1}$, Salvador Carranza$^{1}$, and Dean C. Adams$^{4}$}
\end{center}

\begin{center}\DIFdelbegin \DIFdel{30 September}\DIFdelend \DIFaddbegin \DIFadd{05 October}\DIFaddend , 2022\end{center}
...
performance. In vertebrates, ecomorphological trends have been \DIFdelbegin \DIFdel{well-studied }\DIFdelend \DIFaddbegin \DIFadd{well
studied }\DIFaddend in numerous taxonomic groups, and include the emblematic
...
specialization has an impact in this \DIFdelbegin \DIFdel{relationship }\DIFdelend shape-size \DIFdelbegin \DIFdel{. (how the
size-shape relationshipdiffers among habitats.
) }\DIFdelend \DIFaddbegin \DIFadd{relationship.
...
habitat utilization. Overall our results demonstrate that \DIFaddbegin \DIFadd{the interplay
between ecological specialization and }\DIFaddend differing allometric trajectories
\DIFdelbegin \DIFdel{across habitats can result in similar overall
phenotypes, even when those species display differing body sizes across
habitat types }\textbf{\DIFdel{maybe some other general ending sentence here?}}%DIFAUXCMD
\DIFdelend \DIFaddbegin \DIFadd{in species with disparate body size may have a determinant role in
...
the pattern of \DIFdelbegin \DIFdel{multivaraite }\DIFdelend \DIFaddbegin \DIFadd{multivariate }\DIFaddend allometry across individuals was concordant
...
\DIFdelbegin \DIFdel{rock-dwelling
}\DIFdelend \DIFaddbegin \DIFadd{ground-dwelling }\DIFaddend animals was more extreme as compared with either \DIFdelbegin \DIFdel{ground }\DIFdelend \DIFaddbegin \DIFadd{rock }\DIFaddend or
...
rock-dwelling species\DIFdelbegin \DIFdel{; }\DIFdelend \DIFaddbegin \DIFadd{, }\DIFaddend who displayed shallower head allometry (Figure
...
species in general were more variable in \DIFdelbegin \DIFdel{their patterns of limb
allometry }\DIFdelend \DIFaddbegin \DIFadd{such patterns }\DIFaddend (Figure 3B).
...
\caption{\label{tab:unnamed-chunk-1}Multivariate analysis of covariance describing variation in body form in \DIFdelbeginFL \DIFdelFL{extit}%DIFDELCMD < {%%%
\DIFdelFL{Pristurus}%DIFDELCMD < }%%%
\DIFdelendFL \DIFaddbeginFL \textit{\DIFaddFL{Pristurus}}\DIFaddendFL .}
\centering
...
Individuals \DIFdelbegin \DIFdel{re }\DIFdelend \DIFaddbegin \DIFadd{are }\DIFaddend colored by habitat use: \DIFdelbegin \DIFdel{rock }\DIFdelend \DIFaddbegin \DIFadd{ground }\DIFaddend (beige), \DIFdelbegin \DIFdel{ground }\DIFdelend \DIFaddbegin \DIFadd{rock }\DIFaddend (dark
purple), and tree (magenta). \DIFaddbegin \DIFadd{Isometric trend represented by the dashed
line. }\DIFaddend \hfill\break
...
are colored by habitat use: \DIFdelbegin \DIFdel{rock }\DIFdelend \DIFaddbegin \DIFadd{ground }\DIFaddend (beige), \DIFdelbegin \DIFdel{ground }\DIFdelend \DIFaddbegin \DIFadd{rock }\DIFaddend (dark purple), and tree
(magenta). \hfill\break
...
means are colored by habitat use: \DIFdelbegin \DIFdel{rock }\DIFdelend \DIFaddbegin \DIFadd{grou d }\DIFaddend (beige), \DIFdelbegin \DIFdel{ground }\DIFdelend \DIFaddbegin \DIFadd{rock }\DIFaddend (dark purple),
