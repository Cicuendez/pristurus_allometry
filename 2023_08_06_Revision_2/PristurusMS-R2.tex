...
obtained from a phylogenetic regression, and another one for species
...
(\(\theta = 5.64^\circ\); Table 1). This revealed that the pattern of
...
allometry in each (Table 3). Additionally, comparisons identified that
...
habitats (Table 3; Figure 2). Here, regression coefficients of each
...
indicating strong congruence between them (Table 4). By contrast,
