...
%DIF DEL PristurusMS-R1-text.tex       Mon Aug 14 17:53:01 2023
%DIF ADD PristurusMS-R2-DCA-text.tex   Mon Aug 14 18:05:00 2023
...
overall estimate of \DIFdelbegin \DIFdel{static }\DIFdelend \DIFaddbegin \DIFadd{intraspecific }\DIFaddend allometry among individuals. By first
...
\DIFdelbegin \DIFdel{static }\DIFdelend \DIFaddbegin \DIFadd{intraspecific }\DIFaddend and evolutionary allometry to be disentangled \DIFdelbegin \DIFdel{. }\DIFdelend \DIFaddbegin \DIFadd{(note that
...
conservative). }\DIFaddend From both the species-level and the individual-level
analyses, we obtained the set of regression coefficients, which
respectively described the trajectories of evolutionary and
\DIFdelbegin \DIFdel{static }\DIFdelend \DIFaddbegin \DIFadd{intraspecific }\DIFaddend allometry in morphospace. We then calculated the
difference in their direction in morphospace to discern the extent to
which patterns of \DIFdelbegin \DIFdel{static }\DIFdelend \DIFaddbegin \DIFadd{intraspecific }\DIFaddend allometry at the individual level were
...
trends in \DIFdelbegin \DIFdel{static }\DIFdelend \DIFaddbegin \DIFadd{intraspecific }\DIFaddend allometry differed across habitat groups. This
...
well. \DIFaddbegin \DIFadd{These results did not change when the phylomorphospace was based
on size-standardized species means obtained from a phylogenetic
regression (Supplementary Material). }\DIFaddend \hfill\break
