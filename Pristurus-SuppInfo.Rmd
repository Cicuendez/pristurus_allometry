...
```{r, fig.pos="H", fig.align="center",echo=FALSE, out.width="100%", fig.cap= "Traitgrams of regression slopes for each phenotypic variable. Colors designate habitat groups."}
